...
> 由 [dshp](https://github.com/carbide4826/dsh-plugin-cli) 生成 · 依赖版本 DSH {{DSH_VERSION}}

　　**版本跟随 dsh**:所有 `@deepseek-ai/dsh-*` 跟随 DSH 版本线,当前固定在 {{DSH_VERSION}};后续随官方迭代跟踪更新。
...
```sh
pnpm add -D @deepseek-ai/dsh@{{DSH_VERSION}}  # 安装 dsh(②)
```
